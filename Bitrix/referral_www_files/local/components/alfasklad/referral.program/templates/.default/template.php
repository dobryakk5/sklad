        ...
        <div class="lk-referral-stats-layout">
            <div class="lk-referral-stats-list">
                ...
                <div class="lk-referral-stat-item">
                    ...
                    <strong><?= (int)$arResult["FRIENDS_TOTAL"] ?></strong>
                ...
                <div class="lk-referral-stat-item">
                    ...
                    <strong><?= (int)$arResult["FRIENDS_ACTIVE"] ?></strong>
                    <span>арендуют</span>
                </div>
                ...
                <div class="lk-referral-stat-item">
                    ...
                    <strong><?= number_format((float)$arResult["BONUS_PAID"], 0, '.', ' ') ?> ₽</strong>
                    <span>выплачено</span>
                </div>
                ...
                <div class="lk-referral-stat-item">
                    ...
                    <strong><?= number_format((float)$arResult["BONUS_PLANNED"], 0, '.', ' ') ?> ₽</strong>
