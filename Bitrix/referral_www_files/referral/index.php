    ...
    <section class="referral-hero">
        <div class="referral-hero-inner">
            ...
            <div class="referral-hero-content">
                <div class="referral-eyebrow">Реферальная программа</div>
                ...
                <p class="referral-hero-text">
                    Делитесь промокодом с друзьями и получайте бонус за каждого нового клиента.
                    <strong>на ваш “баланс”</strong>
                </p>
                ...
                <a href="https://alfasklad.ru/cabinet/docs/" class="btn btn-default btn-lg referral-main-btn">
                    Участвовать в программе
                </a>
            </div>

            <div class="referral-hero-visual" aria-hidden="true">
                <div class="referral-lightning"></div>
