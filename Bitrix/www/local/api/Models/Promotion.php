...
class Promotion extends Model
{
    ...
    /**
     * Получение полей одной промо-акции по ID
     * @param int $id
     * @return static
     */
    public static function getPromotion(int $id)
    {
        $arFilter = array(
    ...
    public static function getPromotionsList(int $limit = null, int $lastId = null)
    {
        $arFilter = array(
            'IBLOCK_ID' => self::IBLOCK_ID,
            'ACTIVE' => 'Y',
    ...
    {
        return (string) $this->fields['DETAIL_TEXT'];
    }
}