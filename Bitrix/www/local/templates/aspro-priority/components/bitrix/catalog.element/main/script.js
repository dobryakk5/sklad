...
$(document).ready(function (){
	...
	$('html').on('click', '.catalog_detail .counter_wrapp .counter .ctrl', function() {
		var input = $(this).closest('.counter').find('input.count');
		var count = parseFloat(input.val());
		var elClass = $.trim($(this).attr('class')),
		...
		$(this).closest('.buy_block').find('.to-cart').attr('data-quantity', newCount);
	})
	
	$('html').on('input', '.catalog_detail .counter_wrapp .counter input.count', function() {
		$(this).closest('.buy_block').find('.to-cart').attr('data-quantity', $(this).val());
	})
