...
$res = CIBlockSection::GetList(Array("SORT"=>"ASC"), Array("IBLOCK_ID"=>$arParams["IBLOCK_ID"], "ACTIVE"=>"Y", "DEPTH_LEVEL"=>1, "ID" => $arResult["SECTION"]["ID"]), false, Array("UF_MAP", "UF_ADDRESS", "UF_RECEPTION", "UF_DOSTUP_TIME", "UF_PHONE", "UF_PRICE_ON_MAP"));
