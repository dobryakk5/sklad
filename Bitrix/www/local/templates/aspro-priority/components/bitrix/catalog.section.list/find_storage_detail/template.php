    ...
    <div class="find_storage_detail">
        <div class="row">
            <div class="col-md-6 col-xs-12">
                ...
                <div class="buttons">
                    <?php /*<a class="btn btn-default scroll" href="#formManagerOrder_block">Арендовать через менеджера</a> */ ?>
                    <a class="btn btn-default btn-transparent"
                       href="/rental_catalog/<?= $arResult["SECTION"]["CODE"] ?>/">Арендовать на сайте</a>
                </div>
