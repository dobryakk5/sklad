...
<?}?>
		...
		<div class="box_filter_slider">
			<div class="flexslider flexslider-init flexslider-direction-nav" id="mobile_slider">
				<ul class="slides">
			...
			<div class="thmb_wrap">
				<div class="thmb flexslider unstyled" id="mobile_carousel" data-thmb-width="<?=$thmb_width?>">
					<ul class="slides">
						<?if(strlen($arParams["SIZE_FROM"]) > 0) {?>
							<?if(file_exists($_SERVER["DOCUMENT_ROOT"].$arResult["GALLERY_SQUARE_PICTURE"]["BIG"])) {?>
								<li class="blink">
