			...
			<div class="list_item_wrapp item_wrap item">
				<table class="list_item" id="<?=$arItemIDs["strMainID"];?>">
					...
					<td class="description_wrapp">
						<div class="description">
							...
							<?if($boolShowProductProps || $boolShowOfferProps):?>
								...
								<div class="show_props dark_link mt10" onclick="$(this).parent().find('.props_list_wrapp').toggle(100)">
					...
					<td class="information_wrapp main_item_wrapper">
						<div class="information pull-right <?=($arItem["OFFERS"] && $arItem['OFFERS_PROP'] ? 'has_offer_prop' : '');?>  inner_content js_offers__<?=$arItem['ID'];?>">
							...
							<?if(!$arItem["OFFERS"] || $arParams['TYPE_SKU'] !== 'TYPE_1'):?>
								<div class="counter_wrapp <?=($arItem["OFFERS"] && $arParams["TYPE_SKU"] == "TYPE_1" ? 'woffers' : '')?> mt20">
                                    <? if(empty($arItem["OFFERS"])):?>
									<?if(($arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_LIST"] == 'qwe' && $arAddToBasketData["ACTION"] == "ADD") && $arAddToBasketData["CAN_BUY"]):?>
