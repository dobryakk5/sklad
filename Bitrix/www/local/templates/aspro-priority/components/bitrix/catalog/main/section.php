...
global $arTheme, $NextSectionID, $arRegion, $showIcons,$bShowToogle;
...
if ($section) {
    ...
    $posSectionDescr = COption::GetOptionString("aspro.priority", "SHOW_SECTION_DESCRIPTION", "BOTTOM", SITE_ID);
...
<?
//seo
$catalogInfoIblockId = CNextCache::$arIBlocks[SITE_ID]["aspro_priority_catalog"]["aspro_priority_catalog_info"][0];
...
<div class="row relative">
    <?if($arTheme["SIDE_MENU"]["VALUE"] == "LEFT" || $arTheme["SIDE_MENU"]["VALUE"] == "RIGHT"):?>
        <div class="xs-custom-block col-md-3 col-sm-3 hidden-xs hidden-sm<?=($arTheme["SIDE_MENU"]["VALUE"] == "RIGHT" ? ' right-menu-md pull-right' : ' left-menu-md')?>">
