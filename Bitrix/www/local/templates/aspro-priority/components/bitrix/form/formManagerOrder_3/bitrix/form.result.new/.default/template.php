...
<?if(strlen($arResult["FORM_NOTE"]) > 0) {?>
	<?if($arResult["isFormErrors"] != "Y") {?>
		...
		<?
		$arResult["FORM_NOTE"] = "Большое спасибо! Заявка успешно отправлена менеджеру. Мы обязательно свяжемся с вами.";
		?>

		<script>
			/*							
			gtag('event', 'send_form', {
			  'event_category' : 'oprosnik'
			});    
			yaCounter50400436.reachGoal('oprosnik'); 
			*/ 
			/* Таргет Консалт Компани */ 
			dataLayer.push({'event': 'oprosnik'});            
		</script>	
	<?}?>
<?}?>
	...
	<div class="form-managerOrder2">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<div class="h5"><?=$arResult["FORM_TITLE"]?></div>
				<div class="text">
