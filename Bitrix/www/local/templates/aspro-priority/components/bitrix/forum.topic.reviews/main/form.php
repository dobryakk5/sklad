	...
	<div style="position:relative; display: block; width:100%;">
		...
		<div class="reviews-reply-field reviews-reply-field-settings filter">
			...
			if ($arResult["FORUM"]["ALLOW_SMILES"] == "Y"):
				?>
				<div class="reviews-reply-field-setting bx_filter">
			...
			if ($arResult["SHOW_SUBSCRIBE"] == "Y"):
				...
				<div class="reviews-reply-field-setting bx_filter">
					...
					?><label for="TOPIC_SUBSCRIBE<?=$arParams["form_index"]?>"><span class="bx_filter_input_checkbox"><?=GetMessage("F_WANT_SUBSCRIBE_TOPIC")?></span></label>
                </div>
			<?
			endif;
			?>
