...
<div class="webform-field-item-wrap load-item"><span class="webform-field-upload-icon webform-field-upload-icon-#ext#"><img src="#preview_url#" onerror="BX.remove(this);" /></span>
<a href="#url#" target="_blank" data-bx-role="file-name" class="upload-file-name">#name#</a><span class="upload-file-size" data-bx-role="file-size">#size#</span><i></i><del data-bx-role="file-delete">&#215;</del>
<input id="file-#file_id#" data-bx-role="file-id" type="hidden" class="FILE" name="#input_name#" value="#file_id#" /></div>
HTML;
$thumb = <<<HTML
...
<div class="file-input">
	...
	<?if ($arParams["ALLOW_UPLOAD"] != "N")
	{
		?><div class="webform-field-upload" id="mfi-<?=$arParams['CONTROL_ID']?>-button"><?
			...
			?><span class="<? /*webform-small-button webform-button-upload */ ?>btn btn-transparent btn-xs"><?=$inputCaption?></span><?
