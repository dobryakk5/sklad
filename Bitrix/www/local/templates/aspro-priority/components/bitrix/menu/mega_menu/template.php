					...
					<tr>
						<?foreach($arResult as $arItem):?>					
							...
							<td class="menu-item unvisible <?=($arItem["CHILD"] ? "dropdown" : "")?>  <?=($arItem["SELECTED"] ? "active" : "")?>">
								<div class="wrap">
									<a class="dark-color <?=($arItem["CHILD"] && $bShowChilds ? "dropdown-toggle" : "")?>" href="<?=$arItem["LINK"]?>">
										<?=$arItem["TEXT"]?>
										...
										<ul class="dropdown-menu">
											<?foreach($arItem["CHILD"] as $arSubItem):?>
												...
												<li class="<?=($arSubItem["CHILD"] && $bShowChilds ? "dropdown-submenu" : "")?> <?=($arSubItem["SELECTED"] ? "active" : "")?>">
													<a href="<?=$arSubItem["LINK"]?>"><?=$arSubItem["TEXT"]?><?=($arSubItem["CHILD"] && $bShowChilds ? '<span class="arrow"><i></i></span>' : '')?></a>
