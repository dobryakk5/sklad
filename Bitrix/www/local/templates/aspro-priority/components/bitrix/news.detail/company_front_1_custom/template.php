				...
				<div class="item col-md-6">
					<div class="text">
						...
						<?if(isset($arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']) && $arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']['VALUE']):?>
							<div class="h2"><?=$arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']['VALUE'];?></div>
						<?endif;?>
						...
						<?endif;?>	
						<?if(strlen($arResult['PROPERTIES']['MORE_TEXT']['~VALUE']['TEXT']) > 0) {?>
									...
									<a class="fancybox" rel="nofollow">
										...
										<?elseif($arResult['DISPLAY_PROPERTIES']['VIDEO_SOURCE']['VALUE_XML_ID'] == 'LINK'):?>
											<?//if($bVideoPlayerYoutube):?>
												<iframe width="100%" height="100%"  id="player_<?=$videoID;?>" class="video'<?=($bVideoCover ? ' cover' : '');?>" src="<?=$videoPlayerSrc;?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"></iframe>
