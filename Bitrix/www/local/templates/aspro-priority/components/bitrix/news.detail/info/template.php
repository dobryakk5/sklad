		...
		<div class="maxwidth-theme">
			<div class="item clearfix">
				...
				<?if($bMainAction):?>
					...
					?>
					<div class="image"><img widht="227" height="250" class="img-responsive lazy" data-src="<?=$arImage['src'];?>" alt="<?=$arResult['NAME'];?>" title="<?=$arResult['NAME'];?>"></div>
				<?endif;?>
				<div class="body-info<?=(!$bMainAction ? ' wti' : '')?>">
					<?if(isset($arResult['DISPLAY_PROPERTIES']['INFO_BLOCK_NAME']) && $arResult['DISPLAY_PROPERTIES']['INFO_BLOCK_NAME']['VALUE']):?>
						<div class="title"><div class="h2"><?=$arResult['DISPLAY_PROPERTIES']['INFO_BLOCK_NAME']['VALUE'];?></div></div>
					<?endif;?>
