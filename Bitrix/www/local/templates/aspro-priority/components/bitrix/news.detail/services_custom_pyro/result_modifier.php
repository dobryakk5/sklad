...
if($arResult['DISPLAY_PROPERTIES']){
    ...
    if($arResult['DISPLAY_PROPERTIES']['PHOTOS_SLIDER_1']['VALUE'] && is_array($arResult['DISPLAY_PROPERTIES']['PHOTOS_SLIDER_1']['VALUE'])){
        foreach($arResult['DISPLAY_PROPERTIES']['PHOTOS_SLIDER_1']['VALUE'] as $img){
            $arResult['PHOTOS_SLIDER_1'][] = array(
                'DETAIL' => ($arPhoto = CFile::GetFileArray($img)),
                'PREVIEW' => CFile::ResizeImageGet($img, array('width' => 1500, 'height' => 1500), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true),
                'THUMB' => CFile::ResizeImageGet($img, array('width' => 60, 'height' => 60), BX_RESIZE_IMAGE_EXACT, true),
                'TITLE' => (strlen($arPhoto['DESCRIPTION']) ? $arPhoto['DESCRIPTION'] : (strlen($arResult['DETAIL_PICTURE']['TITLE']) ? $arResult['DETAIL_PICTURE']['TITLE']  :(strlen($arPhoto['TITLE']) ? $arPhoto['TITLE'] : $arResult['NAME']))),
    ...
    if($arResult['DISPLAY_PROPERTIES']['PHOTOS_SLIDER_2']['VALUE'] && is_array($arResult['DISPLAY_PROPERTIES']['PHOTOS_SLIDER_2']['VALUE'])){
        foreach($arResult['DISPLAY_PROPERTIES']['PHOTOS_SLIDER_2']['VALUE'] as $img){
            $arResult['PHOTOS_SLIDER_2'][] = array(
                'DETAIL' => ($arPhoto = CFile::GetFileArray($img)),
                'PREVIEW' => CFile::ResizeImageGet($img, array('width' => 1500, 'height' => 1500), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true),
                'THUMB' => CFile::ResizeImageGet($img, array('width' => 60, 'height' => 60), BX_RESIZE_IMAGE_EXACT, true),
                'TITLE' => (strlen($arPhoto['DESCRIPTION']) ? $arPhoto['DESCRIPTION'] : (strlen($arResult['DETAIL_PICTURE']['TITLE']) ? $arResult['DETAIL_PICTURE']['TITLE']  :(strlen($arPhoto['TITLE']) ? $arPhoto['TITLE'] : $arResult['NAME']))),
