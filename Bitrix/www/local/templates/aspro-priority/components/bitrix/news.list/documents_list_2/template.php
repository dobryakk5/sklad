...
<?if($arResult['SECTIONS']):?>
	<div class="item-views documents_list type_2">
		...
		<div class="group-content" itemscope itemtype="https://schema.org/WebPage">

			<meta itemprop="name" content="Документы компании АльфаСклад">
			<meta itemprop="description" content="На этой странице представлены основные документы компании АльфаСклад, включая сертификаты, лицензии и другие файлы в формате PDF.">
			<meta itemprop="url" content="https://alfasklad.ru/about/documents/">
							...
							<div class="docs_wrap row margin0">
								<?foreach($arSection['ITEMS'] as $arItem):?>
									...
									<?if(isset($arItem['DISPLAY_PROPERTIES']['DOCUMENT']) && $arItem['DISPLAY_PROPERTIES']['DOCUMENT']['VALUE']):?>
										...
										?>
										<div class="item pull-left" id="<?=$this->GetEditAreaId($id)?>" itemscope itemprop="mainEntity" itemtype="https://schema.org/MediaObject">
											<div class="blocks border shadow clearfix <?=$arItem["TYPE"];?>">
												<div class="inner-wrapper">
													<div class="title">
														<a href="/pdfjs/web/?file=<?=$arItem['SRC']?>" class="dark-color text<?=($bImage ? ' fancybox' : '')?>" rel="nofollow" target="_blank" itemprop="contentUrl">
															<span itemprop="name"><?=$name;?></span>
														</a>
													</div>
													<div class="filesize font_xs"><?=CPriority::filesize_format($arItem['FILE_SIZE']);?></div>
													<?if($bImage):?>
														<a class="arrow_link fancybox" href="<?=$arItem['SRC']?>" rel="nofollow"></a>
													<?else:?>
														<a href="<?=$arItem['SRC']?>" class="arrow_link" href="<?=$arItem['SRC']?>" rel="nofollow" target="_blank"></a>
													<?endif;?>
												</div>
											</div>
											<meta itemprop="encodingFormat" content="application/pdf">
											<span itemscope itemprop="author" itemtype="https://schema.org/Organization">
												<meta itemprop="name" content="Компания АльфаСклад">
											</span>
										</div>
									<?endif;?>
								<?endforeach;?>
