...
<?if($arResult['ITEMS']):?>
	<div class="item-views news-items type_1 front news_list useful_for_rental">

		<div class="title-news">
			<a class="show_all pull-right" href="/about/useful_for_rental/"><span>Перейти в раздел</span></a>
			<h5>Все о хранении, узнайте все нюансы</h5>
