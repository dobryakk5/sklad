...
<?if($arResult['ITEMS']):?>
	<div class="useful_for_rental item-views news-items type_1 ---front news_list">

		<a class="show_all pull-right" href="<?=str_replace("#SITE_DIR#", SITE_DIR, $arResult["LIST_PAGE_URL"])?>"><span><?=(strlen($arParams["SHOW_ALL_TITLE"])>0)?$arParams["SHOW_ALL_TITLE"]:'Перейти в раздел'?></span></a>
		<h2 class="style-h3"><?=(strlen($arParams["TITLE"])>0)?$arParams["TITLE"]:$arResult["NAME"]?></h2>
		...
		<div class="items row flexbox">
			...
			<?foreach($arResult['ITEMS'] as $i => $arItem):?>
				...
				//(isset($arItem['DISPLAY_PROPERTIES']['BIG_BLOCK']) && $arItem['DISPLAY_PROPERTIES']['BIG_BLOCK']['VALUE_XML_ID'] == 'Y' ? true : false);
				?>
				<div class="item <?=(!$bImage ? ' wti' : '')?> col-md-3 col-sm-4 col-xs-6">
