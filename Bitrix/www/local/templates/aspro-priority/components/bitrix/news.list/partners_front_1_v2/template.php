...
<? if ($arResult['ITEMS']) { ?>
    <div class="maxwidth-theme">
        <div class="shadow-box">
            <div class="item-views partners front type_1 partners_scroll partners_custom">
						...
						*/ ?>
                        <? if ($arParams['PAGER_SHOW_ALL']): ?>
                            <a class="show_all pull-right"
                               href="<?= str_replace('#SITE' . '_DIR#', SITE_DIR, $arResult['LIST_PAGE_URL']) ?>"><span><?= (strlen($arParams['SHOW_ALL_TITLE']) ? $arParams['SHOW_ALL_TITLE'] : GetMessage('S_TO_SHOW_ALL_PARTNERS')) ?></span></a>
                        <? endif; ?>
                        <h3><?= ($arParams["TITLE"] ? $arParams["TITLE"] : Loc::getMessage("TITLE_PARTNERS")); ?></h3>

                        <div class="flexslider unstyled row navigation-vcenter dark-nav"
                             data-plugin-options='{"directionNav": true, "controlNav" :false, "animationLoop": true, <?= ($bAnimation ? '"slideshow": true,' : '"slideshow": false,') ?> "counts": [4, 3, 2, 1]}'>
                                        ...
                                        <div class="wrap" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                                            <div class="image">
                                                <? if ($bDetailLink): ?><a
                                                    ...
                                                    <img width="150" height="83" class="img-responsive lazy"
                                                         src="<?= $templateFolder ?>/images/empty.jpg"
                                                         data-src="<?= $imageSrc ?>"
