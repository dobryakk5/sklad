            ...
            <div class="card__inner">
                <div class="card__header">
                    <h2 class="card__title">
                        <span class="text_accent">Отзывы</span> наших Клиентов
                    </h2>
                </div>
                ...
                <div class="swiper reviews__swiper">
                    <div class="swiper-wrapper">
                        <?php foreach ($arResult['ITEMS'] as $i => $arItem): ?>
                            ...
                            <div class="swiper-slide reviews__card" itemscope itemtype="http://schema.org/Review" id="<?= $this->GetEditAreaId($arItem['ID']) ?>">
                                <?
                                    ...
                                    <? if ($bImage && $arImage['src']): ?>
                                        <div class="image  <?= ($bImage ? '' : 'wpi') ?>">
                                            <img data-src="<?= $arImage['src'] ?>"
                                                ...
                                                class="reviews__card-avatar lazy" />
                                        </div>
                                    <? endif; ?>

                                    <? if ($name): ?>
                                        <div class="reviews__card-block">
                                            <p class="reviews__card-name text_l" itemprop="author" itemscope itemtype="https://schema.org/Person">
                                                <?= $name ?>
                                                <meta itemprop="name" content="<?= $name ?>">
                                            </p>
                                            <img class="reviews__card-logo" src="/images/logos/yandex_maps.svg" alt="yandex-maps-logo">
                                        </div>
                                    <? endif; ?>
                                </div>
                                ...
                                <? if ($bRating): ?>
                                    ...
                                    ?>
                                    <div class="reviews__stars" itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating">
                                        <meta itemprop="worstRating" content="0">
                                        <meta itemprop="ratingValue" content="5">
                                        <meta itemprop="ratingValue" content="5">
                                        <img class="reviews__star" src="/images/icons/x20/star_x20.svg" alt="star">
                                        <img class="reviews__star" src="/images/icons/x20/star_x20.svg" alt="star">
                                        <img class="reviews__star" src="/images/icons/x20/star_x20.svg" alt="star">
                                        <img class="reviews__star" src="/images/icons/x20/star_x20.svg" alt="star">
                                        <img class="reviews__star" src="/images/icons/x20/star_x20.svg" alt="star">
                                ...
                                <? if ($review): ?>
                                    <p class="reviews__description text_m" itemprop="reviewBody"><?= $review ?></p>
                                <? endif; ?>
                            </div>
                        <?php endforeach; ?>
                    </div>
                ...
                <div class="swiper-pagination swiper-pagination_custom swiper-pagination_reviews"></div>

                <div class="swiper-button_custom swiper-button-prev_custom swiper-button-prev_reviews">
                ...
                <div class="swiper-button_custom swiper-button-next_custom swiper-button-next_reviews">
                    <svg width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
