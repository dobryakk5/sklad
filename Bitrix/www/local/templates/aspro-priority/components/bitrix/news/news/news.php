...
$APPLICATION->SetPageProperty('TITLE','Полезная информация по хранению вещей | Статьи от компании Альфасклад');
$APPLICATION->SetPageProperty("DESCRIOTION","Полезные статьи от компании Альфасклад. Круглосуточный доступ на склад. Низкие цены ☎ +7 (495) 116-97-83");
}
...
<?if(!$itemsCnt):?>
	<div class="alert alert-warning rr">
        <?
        LocalRedirect("/rental_catalog/");
        ?>
        <?=GetMessage("SECTION_EMPTY")?></div>
<?else:?>
