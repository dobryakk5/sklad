<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FORM_ID_ORDER_SERVISE" => ($arParams["FORM_ID_ORDER_SERVISE"] ? $arParams["FORM_ID_ORDER_SERVISE"] : CCache::$arIBlocks[SITE_ID]["aspro_priority_form"]["aspro_priority_order_services"][0]),
