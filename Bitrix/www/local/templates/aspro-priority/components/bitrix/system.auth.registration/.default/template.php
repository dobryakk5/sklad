...
<table class="data-table bx-registration-table">
	...
	<tbody>
		<tr>
			...
			<td><input type="text" name="USER_NAME" maxlength="50" value="<?=$arResult["USER_NAME"]?>" class="bx-auth-input form-control" /></td>
		</tr>
		<tr>
			<td><?=GetMessage("AUTH_LAST_NAME")?></td>
			<td><input type="text" name="USER_LAST_NAME" maxlength="50" value="<?=$arResult["USER_LAST_NAME"]?>" class="bx-auth-input form-control" /></td>
		</tr>
		<tr>
			<td><span class="starrequired">*</span><?=GetMessage("AUTH_LOGIN_MIN")?></td>
			<td><input type="text" name="USER_LOGIN" maxlength="50" value="<?=$arResult["USER_LOGIN"]?>" class="bx-auth-input form-control" /></td>
		</tr>
		<tr>
...
<?if($arResult["EMAIL_REGISTRATION"]):?>
		<tr>
			...
			<td><input type="text" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" class="bx-auth-input form-control" /></td>
		</tr>
<?endif?>
...
<?if($arResult["PHONE_REGISTRATION"]):?>
		<tr>
			...
			<td><input type="text" name="USER_PHONE_NUMBER" maxlength="255" value="<?=$arResult["USER_PHONE_NUMBER"]?>" class="bx-auth-input form-control" /></td>
		</tr>
<?endif?>
...
<?// ******************** /User properties ***************************************************
	...
	<tfoot>
		<tr>
			<td></td>
			<td><br><input type="submit" class="btn btn-default" name="Register" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
