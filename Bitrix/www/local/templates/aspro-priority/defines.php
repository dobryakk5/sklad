<?
global $showLeftBanner, $arSite, $isMenu, $isIndex, $is404, $indexType, $roundButton, $titleCenter, $showIcons, $bBigBannersIndex, $bTopFloatBannersIndex, $bTopServicesIndex, $bPortfolioIndex, $bPartnersIndex, $bTeasersIndex, $bInstagrammIndex, $bReviewsIndex, $bConsultIndex, $bCompanyIndex, $bTeamIndex, $bNewsIndex, $pagerMoreBtn;
?>
...
<?//$isServices = false;?>
<?$isServices = CSite::inDir(SITE_DIR."services/") && !CSite::inDir(SITE_DIR."services/khraneniya-pod-klyuch");?>
<?$isServicesKhraneniya = CSite::inDir(SITE_DIR."services/khraneniya-pod-klyuch");?>
...
<?if($isIndex = CSite::inDir(SITE_DIR."index.php") || $isIndex= CSite::inDir(SITE_DIR."index_test.php") || $isIndex= CSite::inDir(SITE_DIR."new-layout/index.php")):?>
...
<?endif;?>
<?php $isNewIndex = CSite::inDir(SITE_DIR."new-layout/index.php"); ?>
...
if($arRegion && $arTheme['USE_REGIONALITY']['DEPENDENT_PARAMS']['REGIONALITY_FILTER_ITEM']['VALUE'] == 'Y')
{
	...
	$GLOBALS['arRegionLinkUF'] = array('UF_LINK_REGION' => $arRegion['ID']);
	if($isIndex)
	{
