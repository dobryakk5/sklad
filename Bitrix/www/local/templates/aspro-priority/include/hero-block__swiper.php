...
$APPLICATION->AddHeadScript("/local/templates/aspro-priority/js/pages/sliders.js");

if (count($arParams['ITEMS']) > 0 && !empty($arParams['ITEMS'][0])) {
    foreach ($arParams['ITEMS'] as $id) {
        $items[] = [
...
<div class="swiper hero-block__swiper">
    <div class="swiper-wrapper">
        <?php foreach ($items as $item): ?>
            <div class="swiper-slide hero-block__slide">
                <a href="<?= $item['img'] ?>" class="fancybox" data-fancybox-group="hero-group">
...
<div class="swiper-pagination swiper-pagination_custom swiper-pagination_hero-block"></div>

<div class="swiper-button_custom swiper-button-prev_custom swiper-button-prev_hero-block">
...
<div class="swiper-button_custom swiper-button-next_custom swiper-button-next_hero-block">
    <svg width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
