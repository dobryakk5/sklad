	...
	<div class="region_wrapper">
		<div class="io_wrapper">
			<div>
				...
				<div class="js_city_chooser dark-color list with_dropdown" data-param-url="<? /*=urlencode($APPLICATION->GetCurUri()); */ echo '/'; ?>" data-param-form_id="city_chooser">
			...
			<div class="dropdown">
				<div class="wrap">
					<?foreach($arResult['REGIONS'] as $id => $arItem):
                        $arItem['URL'] = str_replace($arResult['URI'], '/', $arItem['URL']);
                        ?>
			...
			<?if($arResult['SHOW_REGION_CONFIRM']):?>
				<div class="confirm_region">
                    ...
                    $href = str_replace($arResult['URI'], '/', $href);
                    ?>
