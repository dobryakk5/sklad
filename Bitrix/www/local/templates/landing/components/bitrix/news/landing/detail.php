...
<?
if (in_array('Адреса складов', $APPLICATION->BLOCKS)) {
...
?>
<?
if (in_array('Форма обратной связи', $APPLICATION->BLOCKS)) {
    ?>
    <div class="maxwidth-theme " id="part3">
...
?>
<?
if (in_array('Фотогалерея', $APPLICATION->BLOCKS)) {
    ?>
    <div class="maxwidth-theme maxwidth-theme_photo" id="part4" style="margin-top: 30px">
        <h2>Фото складов</h2>
    </div>
    <?
    global $arrFilterGalleryMainpage;
    $arrFilterGalleryMainpage["!PROPERTY_MAINPAGE"] = false;
    $arrFilterGalleryMainpage["!SECTION_ID"] = 165;
    ?>
    <? $APPLICATION->IncludeComponent(
        "bitrix:news.list",
        "gallery_mainpage",
