...
<?global $isCabinet, $showLeftCallback, $showLeftAskQuestion, $showLeftAddReview, $showLeftMap, $showLeftBanner;?>

<?if(CSite::InDir("/cabinet/")) {?>
	<?$APPLICATION->IncludeComponent(
		...
		Array(
			...
			"EDIT_TEMPLATE" => "",
			"PATH" => "/include/cabinet/mobile_left_menu.php"
		),
		false,
		Array("HIDE_ICONS"=>"Y")
	);?>
...
<div class="sidearea">
	...
	<?if($showLeftBanner == 'Y'){CPriority::get_banners_position('SIDE');}?>
