        ...
        <div class="left-side">
            <div class="accordeon-socials">
                ...
                <div class="panel"><a data-fancybox="modalCall" href="#modalCall">
                    ...
                    <span>Оставьте свой отзыв</span></a>
            ...
            <div class="form-footer">
                <div data-sid="RATING">
                    <div class="rating_wrap clearfix">
                        <div class="rating">
                        <span class="star" data-current_width="20" data-rating_value="1"
                                                  data-message="Очень плохо"></span>
                                                  <span class="star"
...
<script src="/local/templates/aspro-priority/js/jquery.inputmask.bundle.min.js?164212673770933"></script>
<script src="/local/templates/aspro-priority/js/jquery.uniform.min.js?16421267378308"></script>
<?/*?><?*/?>
<script src="/local/templates/aspro-priority/js/jqModal.min.js?16421267372622"></script>
<script src="/local/templates/aspro-priority/vendor/jquery.validate.min.js?164212673622254"></script>
