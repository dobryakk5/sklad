...
(function () {
    ...
    window.onload = function () {
        ...
        $('.flat-container .rs-flat .item').each(function () {
            ...
            $('.flat-container .rs-flat .item[data-button="small"]').css('width', width * (buttonWidth + 1.2));
        });
    };
})();
